...
!***********************************************************************************
	subroutine plot_4(x1,y1,x2,y2,x3,y3,x4,y4,style,pause,color1,color2,color3,color4, &
						             terminal,filename,polar,persist,input,linewidth, title, xlabel, ylabel)
!***********************************************************************************
...
!***********************************************************************************
	...
	character(len=*),optional	:: style, color1, color2, color3, color4, terminal, filename, polar, &
						                        persist, input, title, xlabel, ylabel
...
!***********************************************************************************
	...
	if (present(polar).and.(polar=='yes')) then
	 ...
	 write ( file_unit, '(a)' ) 'set title "'// trim(title) //'"'
...
!***********************************************************************************
!***********************************************************************************
	subroutine plot_3(x1,y1,x2,y2,x3,y3,style,pause,color1,color2,color3,terminal,filename, &
	                  polar,persist,input,linewidth, title, xlabel, ylabel)
!***********************************************************************************
...
!***********************************************************************************
	...
	real(kind=4), optional		:: pause,linewidth
	character(len=*),optional	:: style, color1, color2, color3, terminal, filename, polar, &
	                             persist, input, title, xlabel, ylabel
...
!***********************************************************************************
	write ( file_unit, '(a)' ) 'set key left bottom'
	if (present(polar).and.(polar=='yes')) then
...
!***********************************************************************************
	if (present(style)) then
		...
		write ( file_unit, '(a,i2,a)' ) 'plot "' // trim (data_file_name) &
		& //'" using 1:2 with ' // trim(my_line_type1)  // ' title "' // trim(key1) // '" linecolor rgb ' &
		// trim(my_color1) // ' linewidth '// trim(my_linewidth) // ',\' 
		write ( file_unit, '(a,i2,a)' ) '     "'// trim (data_file_name) &
		& //'" using 3:4 with ' // trim(my_line_type2)  // ' title "' // trim(key2) // '" linecolor rgb ' &
		// trim(my_color2) // ' linewidth '// trim(my_linewidth) 
	end if
!***********************************************************************************
	if (present(pause)) then
